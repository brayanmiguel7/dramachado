            ...
            <div className='container-fluid mx-0 px-0'>
                <div className='row col-12 col-sm-12 mx-0 px-0'>
                    ...
                    <div className='col-12 bg-green py-3'>
                        ...
                        <div className='col-12 mx-auto px-0 text-md-center'>
                    ...
                    <div className='row col-12 bg-yellow px-0 mx-0 py-3'>
                        <div className='col-auto mx-auto ml-md-5 border-bottom-green'>
                            <h3>¿Cuándo acudir a una consulta?</h3>
                        </div>
                        <div className='col-8 col-md-10 mt-3 mx-auto ml-md-5 px-0'>
                            <div className='col-12 col-md-7 d-block ml-md-auto px-0'>
